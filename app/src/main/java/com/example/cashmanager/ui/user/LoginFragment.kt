package com.example.cashmanager.ui.user
...
import com.example.cashmanager.data.userDb
import com.example.cashmanager.ui.dashboard.DashboardFragment
    ...
    override fun onCreateView(
        ...
        next_button.setOnClickListener {
            ...
            if (!isPasswordValid(password_text.text)) {
                password_layout.error = getString(R.string.cm_error_password)
            } else {
